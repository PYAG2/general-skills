...
// Copy this file to: src/components/ui/code-block.tsx
// Dependencies: motion/react, shiki (for syntax highlighting), lucide-react
  ...
  return (
    <div
      className={cn(
        ...
        "text-zinc-950 dark:text-zinc-50 h-fit overflow-y-auto",
        className,
      )}
    >
      {/* Tab Bar - shows when multiple code samples provided */}
        ...
        >
          <AnimatePresence mode="wait" initial={false} custom={direction}>
            ...
            >
              <SyntaxHighlighter
                code={currentCode}
                language={codeContent[activeTab]?.language || language}
              />
            </motion.div>
          </AnimatePresence>
        </pre>
